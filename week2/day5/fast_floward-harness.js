    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"
          description="Sell a kitty item to the Marketplace" action="kittyItemsMarketSellMarketItem" method = "post" 
          fields="signer itemID price" >
          <account-widget field="signer" label="Signer"></account-widget>
          <text-widget field="itemID" label="Item ID" placeholder="0"></text-widget>
          <text-widget field="price" label="Amount" placeholder="30.0"></text-widget>
        </action-card>
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs"
          description="Read the sale Collection ID" action="kittyItemsMarketReadSaleCollectionIDs" method="get" 
        ...
        <action-card title="DAY 5:  Kitty Items - Burn Item" description="Burn Item from an account" action="BurnKittyItem"
